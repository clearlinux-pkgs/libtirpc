...
Source0  : https://sourceforge.net/projects/libtirpc/files/libtirpc/1.3.2/libtirpc-1.3.2.tar.bz2
...
%prep
%setup -q -n libtirpc-1.3.2
cd %{_builddir}/libtirpc-1.3.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620755600
...
cp %{_builddir}/libtirpc-1.3.2/COPYING %{buildroot}/usr/share/package-licenses/libtirpc/d4b24d1c1f5dca54717237af8f7caaaa493232f1
%make_install
