...
Source0  : https://sourceforge.net/projects/libtirpc/files/libtirpc/1.3.6/libtirpc-1.3.6.tar.bz2
...
%prep
%setup -q -n libtirpc-1.3.6
cd %{_builddir}/libtirpc-1.3.6
%patch -P 1 -p1
pushd ..
cp -a libtirpc-1.3.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729888112
