...
Source0  : https://sourceforge.net/projects/libtirpc/files/libtirpc/1.2.6/libtirpc-1.2.6.tar.bz2
...
%prep
%setup -q -n libtirpc-1.2.6
cd %{_builddir}/libtirpc-1.2.6
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601862292
...
cp %{_builddir}/libtirpc-1.2.6/COPYING %{buildroot}/usr/share/package-licenses/libtirpc/d4b24d1c1f5dca54717237af8f7caaaa493232f1
%make_install
