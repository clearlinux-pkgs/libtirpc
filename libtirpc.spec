...
Version  : 1.3.1
Release  : 24
URL      : https://sourceforge.net/projects/libtirpc/files/libtirpc/1.3.1/libtirpc-1.3.1.tar.bz2
Source0  : https://sourceforge.net/projects/libtirpc/files/libtirpc/1.3.1/libtirpc-1.3.1.tar.bz2
...
%prep
%setup -q -n libtirpc-1.3.1
cd %{_builddir}/libtirpc-1.3.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606926142
...
cp %{_builddir}/libtirpc-1.3.1/COPYING %{buildroot}/usr/share/package-licenses/libtirpc/d4b24d1c1f5dca54717237af8f7caaaa493232f1
%make_install
