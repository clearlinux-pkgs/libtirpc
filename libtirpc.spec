...
Source0  : https://sourceforge.net/projects/libtirpc/files/libtirpc/1.3.4/libtirpc-1.3.4.tar.bz2
...
%prep
%setup -q -n libtirpc-1.3.4
cd %{_builddir}/libtirpc-1.3.4
%patch -P 1 -p1
pushd ..
cp -a libtirpc-1.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696865323
